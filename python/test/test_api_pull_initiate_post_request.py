...
class TestApiPullInitiatePostRequest(unittest.TestCase):
    """ApiPullInitiatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiPullInitiatePostRequest:
        """Test ApiPullInitiatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiPullInitiatePostRequest`
        """
        model = ApiPullInitiatePostRequest()
        if include_optional:
            return ApiPullInitiatePostRequest(
                success = None,
                session_id = None,
    ...
    def testApiPullInitiatePostRequest(self):
        """Test ApiPullInitiatePostRequest"""
