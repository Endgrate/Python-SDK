...
class GetApiErrors200ResponseMeta(BaseModel):
    """
    GetApiErrors200ResponseMeta
    """ # noqa: E501
    count: Optional[StrictInt] = None
    previous: Optional[GetApiErrors200ResponseMetaPrevious] = None
    next: Optional[GetApiErrors200ResponseMetaPrevious] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "previous": GetApiErrors200ResponseMetaPrevious.from_dict(obj["previous"]) if obj.get("previous") is not None else None,
            "next": GetApiErrors200ResponseMetaPrevious.from_dict(obj["next"]) if obj.get("next") is not None else None
        })
        return _obj
