...
class CompletedCallbackSchema(BaseModel):
    """
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="The metadata from ${request.body#/completed_webhook/metadata}.")
    endgrate: Optional[CompletedCallbackSchemaEndgrate] = None
    completed: Optional[StrictBool] = Field(default=None, description="Success flag indicating the transfer has completed.")
    __properties: ClassVar[List[str]] = ["success", "transfer_id", "session_id", "metadata", "endgrate", "completed"]
