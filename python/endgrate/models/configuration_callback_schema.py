...
class ConfigurationCallbackSchema(BaseModel):
    """
    ...
    schemas: Optional[Dict[str, Any]] = Field(default=None, description="Schema information, keyed by endgrate type.")
    passthrough_schemas: Optional[Dict[str, Any]] = Field(default=None, description="Passthrough schema information, keyed by endgrate type.")
    __properties: ClassVar[List[str]] = ["success", "session_id", "endgrate", "schemas", "passthrough_schemas"]
