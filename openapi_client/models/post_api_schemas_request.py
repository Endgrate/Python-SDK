...
class PostApiSchemasRequest(BaseModel):
    """
    PostApiSchemasRequest
    """ # noqa: E501
    session_id: Optional[StrictStr] = None
    data: Optional[List[PostApiSchemasRequestDataInner]] = None
    __properties: ClassVar[List[str]] = ["session_id", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PostApiSchemasRequestDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
