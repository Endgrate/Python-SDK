...
class ConfigurationCallbackSchemaSchemasValue(BaseModel):
    """
    ConfigurationCallbackSchemaSchemasValue
    """ # noqa: E501
    integration_info: Optional[ConfigurationCallbackSchemaSchemasValueIntegrationInfo] = None
    integration: Optional[StrictStr] = None
    var_schema: Optional[ConfigurationCallbackSchemaSchemasValueSchema] = Field(default=None, alias="schema")
    passthrough_fields: Optional[ConfigurationCallbackSchemaSchemasValuePassthroughFields] = None
    __properties: ClassVar[List[str]] = ["integration_info", "integration", "schema", "passthrough_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration_info": ConfigurationCallbackSchemaSchemasValueIntegrationInfo.from_dict(obj["integration_info"]) if obj.get("integration_info") is not None else None,
            "integration": obj.get("integration"),
            "schema": ConfigurationCallbackSchemaSchemasValueSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "passthrough_fields": ConfigurationCallbackSchemaSchemasValuePassthroughFields.from_dict(obj["passthrough_fields"]) if obj.get("passthrough_fields") is not None else None
        })
        return _obj
