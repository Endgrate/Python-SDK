...
class GetApiIntegrations200ResponseProvidersInner(BaseModel):
    """
    GetApiIntegrations200ResponseProvidersInner
    """ # noqa: E501
    provider: Optional[GetApiIntegrations200ResponseProvidersInnerProvider] = None
    integrations: Optional[List[GetApiIntegrations200ResponseProvidersInnerIntegrationsInner]] = None
    __properties: ClassVar[List[str]] = ["provider", "integrations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "provider": GetApiIntegrations200ResponseProvidersInnerProvider.from_dict(obj["provider"]) if obj.get("provider") is not None else None,
            "integrations": [GetApiIntegrations200ResponseProvidersInnerIntegrationsInner.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
