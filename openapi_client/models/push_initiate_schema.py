...
class PushInitiateSchema(BaseModel):
    """
    PushInitiateSchema
    """ # noqa: E501
    ...
    var_schema: Optional[List[EndgrateJsonSchema]] = Field(default=None, description="An array of schemas to be pushed out.", alias="schema")
    ...
    __properties: ClassVar[List[str]] = ["completed_webhook", "configuration_webhook", "error_webhook", "field_selection", "prepopulate", "provider", "redirect_url", "resource_selection", "save_session", "schema", "schema_selection", "statistics", "webhook_concurrency", "bypass_ui"]
