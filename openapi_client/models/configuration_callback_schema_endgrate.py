...
class ConfigurationCallbackSchemaEndgrate(BaseModel):
    """
    ConfigurationCallbackSchemaEndgrate
    """ # noqa: E501
    provider: Optional[StrictStr] = Field(default=None, description="Internal provider name.")
    provider_info: Optional[ConfigurationCallbackSchemaEndgrateProviderInfo] = None
    __properties: ClassVar[List[str]] = ["provider", "provider_info"]
