...
class GetApiPullData200Response(BaseModel):
    """
    GetApiPullData200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    meta: Optional[GetApiPullData200ResponseMeta] = None
    transfer_data: Optional[List[TransferDataSchemaInner]] = Field(default=None, description="Returned transfer data.")
    __properties: ClassVar[List[str]] = ["success", "meta", "transfer_data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GetApiPullData200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
