...
class GetApiIntegrations200ResponseProvidersInnerProvider(BaseModel):
    """
    ...
    endgrate_provider_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "display_name", "url", "image", "auth_type", "specific", "endgrate_provider_type"]
    ...
    def auth_type_validate_enum(cls, value):
        ...
        if value not in set(['oauth', 'api_key', 'custom']):
            raise ValueError("must be one of enum values ('oauth', 'api_key', 'custom')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "endgrate_provider_type": obj.get("endgrate_provider_type")
        })
        return _obj
