...
class ConfigurationCallbackSchemaPassthroughSchemasValueSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "associations", "endgrate_type", "properties", "title", "session_method"]
