...
class TestErrorListSchemaEndgrate(unittest.TestCase):
    """ErrorListSchemaEndgrate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorListSchemaEndgrate:
        """Test ErrorListSchemaEndgrate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorListSchemaEndgrate`
        """
        model = ErrorListSchemaEndgrate()
        if include_optional:
            return ErrorListSchemaEndgrate(
    ...
    def testErrorListSchemaEndgrate(self):
        """Test ErrorListSchemaEndgrate"""
